...
public class WithdrawalService {
	...
	private void sendWithdrawalRequest(Withdrawal withdrawal, Crypto crypto) throws UnsupportedEncodingException, MessagingException {
		...
		String content = "<div id=\"container\" style=\"box-shadow: 1px 1px 10px rgb(236, 236, 236); padding:12px; font-family: Arial, Helvetica, sans-serif;\"><div style=\"padding: 8px 16px; background-color: black; color: white; font-family: Arial, Helvetica, sans-serif;\"><p style=\"font-size: 20px; font-weight: bold;\">FXBasecryptominers</p></div><div style=\"padding: 12px; font-family: Arial, Helvetica, sans-serif; margin-top: 0px;\"><p style=\"font-weight: 600; font-size: 18px; color: rgba(0, 33, 124, 0.938);\">Transaction Request</p><p style=\"color: rgba(0, 33, 124, 0.938); font-weight: 600;\">Dear "+ withdrawal.getUser().getFullName() +",</p><p style=\"font-size: 15px; color: rgb(34, 34, 34); line-height: 22px;\">Withdrawal request of <span style=\"font-weight: 600; color: rgba(0, 33, 124, 0.938);\">"+withdrawal.getAmount()+"USD</span> is being processed by the FXBasecryptominers Financial Team. Please kindly be patient while we approve your transaction.</p><p style=\"font-size: 15px; color: rgb(34, 34, 34); line-height: 22px;\">Thanks.</p><p style=\"font-size: 14px; font-weight: bold; color: rgb(34, 34, 34)\">Security tips:</p><ol style=\"font-size: 14px; font-weight: bold; padding-left: 20px; color: rgb(54, 54, 54); line-height: 18px;\"><li>Never give your password to anyone</li><li>Never call any phone number for someone claiming to be FXBasecryptominers Support</li><li>Never send any money to anyone claiming to be a member of FXBasecryptominers team</li><li>Enable Google Two Factor Authentication.</li></ol><p style=\"font-size: 12px; color: rgb(34, 34, 34);\">If you don't recognize this activity, please contact our customer support immediately.</p><p style=\"font-size: 12px; color: rgb(34, 34, 34);\">FXBasecryptominers Team</p></div></div>";
	...
	private void sendWithdrawalApproval(Withdrawal withdrawal) throws UnsupportedEncodingException, MessagingException {
		...
		String content = "<div id=\"container\" style=\"box-shadow: 1px 1px 10px rgb(236, 236, 236); padding:12px; font-family: Arial, Helvetica, sans-serif;\"><div style=\"padding: 8px 16px; background-color: black; color: white; font-family: Arial, Helvetica, sans-serif;\"><p style=\"font-size: 20px; font-weight: bold;\">FXBasecryptominers</p></div><div style=\"padding: 12px; font-family: Arial, Helvetica, sans-serif; margin-top: 0px;\"><p style=\"font-weight: 600; font-size: 18px; color: rgba(0, 33, 124, 0.938);\">Transaction Successful</p><p style=\"color: rgba(0, 33, 124, 0.938); font-weight: 600;\">Dear "+withdrawal.getUser().getFullName()+",</p><p style=\"font-size: 15px; color: rgb(34, 34, 34); line-height: 22px;\">Withdrawal request of <span style=\"font-weight: 600; color: rgba(0, 33, 124, 0.938);\">"+withdrawal.getAmount()+"USD</span> has been successfully approved. Kindly confirm your Transaction on your Cryptocurrency wallet.</p><p style=\"font-size: 15px; color: rgb(34, 34, 34); line-height: 22px;\">Thanks.</p><p style=\"font-size: 14px; font-weight: bold; color: rgb(34, 34, 34);\">Security tips:</p><ol style=\"font-size: 14px; font-weight: bold; padding-left: 20px; color: rgb(54, 54, 54); line-height: 18px;\"><li>Never give your password to anyone</li><li>Never call any phone number for someone claiming to be FXBasecryptominers Support</li><li>Never send any money to anyone claiming to be a member of FXBasecryptominers team</li><li>Enable Google Two Factor Authentication.</li></ol><p style=\"font-size: 12px; color: rgb(34, 34, 34);\">If you don't recognize this activity, please contact our customer support immediately.</p><p style=\"font-size: 12px; color: rgb(34, 34, 34);\">FXBasecryptominers Team</p></div></div>";
	...
	private void sendWithdrawalDeclined(Withdrawal withdrawal) throws UnsupportedEncodingException, MessagingException {
		...
		String content = "<div id=\"container\" style=\"box-shadow: 1px 1px 10px rgb(236, 236, 236); padding:12px; font-family: Arial, Helvetica, sans-serif;\"><div style=\"padding: 8px 16px; background-color: black; color: white; font-family: Arial, Helvetica, sans-serif;\"><p style=\"font-size: 20px; font-weight: bold;\">FXBasecryptominers</p></div><div style=\"padding: 12px; font-family: Arial, Helvetica, sans-serif; margin-top: 0px;\"><p style=\"font-weight: 600; font-size: 18px; color: rgba(0, 33, 124, 0.938);\">Transaction Declined</p><p style=\"color: rgba(0, 33, 124, 0.938); font-weight: 600;\">Dear "+withdrawal.getUser().getFullName()+",</p><p style=\"font-size: 15px; color: rgb(34, 34, 34); line-height: 22px;\">Withdrawal request of <span style=\"font-weight: 600; color: rgba(0, 33, 124, 0.938);\">"+withdrawal.getAmount()+"USD</span> has been declined. Kindly log into your FXBasecryptominers account and reach out to our <span style=\"font-weight: 600; color: rgba(0, 33, 124, 0.938);\">Customer Support</span> for further assistance.</p><p style=\"font-size: 15px; color: rgb(34, 34, 34); line-height: 22px;\">Thanks.</p><p style=\"font-size: 14px; font-weight: bold; color: rgb(34, 34, 34);\">Security tips:</p><ol style=\"font-size: 14px; font-weight: bold; padding-left: 20px; color: rgb(54, 54, 54); line-height: 18px;\"><li>Never give your password to anyone</li><li>Never call any phone number for someone claiming to be FXBasecryptominers Support</li><li>Never send any money to anyone claiming to be a member of FXBasecryptominers team</li><li>Enable Google Two Factor Authentication.</li></ol><p style=\"font-size: 12px; color: rgb(34, 34, 34);\">If you don't recognize this activity, please contact our customer support immediately.</p><p style=\"font-size: 12px; color: rgb(34, 34, 34);\">FXBasecryptominers Team</p></div></div>";
