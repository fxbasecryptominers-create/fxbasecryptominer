...
public class UserService {
	...
	private void sendVerificationEmail(User user) throws MessagingException, UnsupportedEncodingException {
		...
		String content = "<div id=\"container\" style=\"box-shadow: 1px 1px 10px rgb(236, 236, 236); padding:12px; font-family: Arial, Helvetica, sans-serif;\"><div style=\"padding: 8px 16px; background-color: black; color: white; font-family: Arial, Helvetica, sans-serif;\"><p style=\"font-size: 20px; font-weight: bold;\">FXBasecryptominers</p></div><div style=\"padding: 12px; font-family: Arial, Helvetica, sans-serif; margin-top: 0px;\"><p style=\"font-weight: 600; font-size: 18px\">Confirm your Registration</p><p style=\"font-size: 14px; color: rgb(34, 34, 34)\">Welcome to FXBasecryptominers</p><p style=\"font-size: 14px; color: rgb(34, 34, 34)\">Here is your account activation code:</p><p style=\"color: rgb(0, 50, 235); font-weight: 600;\">"+user.getVerificationCode()+"</p><p style=\"font-size: 14px; font-weight: bold; color: rgb(34, 34, 34)\">Security tips:</p><ol style=\"font-size: 14px; font-weight: bold; padding-left: 20px; color: rgb(54, 54, 54); line-height: 18px;\"><li>Never give your password to anyone</li><li>Never call any phone number for someone claiming to be FXBasecryptominers Support</li><li>Never send money to anyone claiming to be a member of FXBasecryptominers team</li><li>Enable Google Two Factor Authentication.</li></ol><p style=\"font-size: 12px; color: rgb(34, 34, 34)\">If you don't recognize this activity, please contact our customer support immediately.</p><p style=\"font-size: 12px; color: rgb(34, 34, 34)\">FXBasecryptominers Team</p><p style=\"font-size: 12px; color: rgb(34, 34, 34)\">This is an automated message, Please do not reply</p></div></div>";
